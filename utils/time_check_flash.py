from model.schnet_model_flash import SchNetModel
import torch
import argparse
...
def main():
    ...
    dst_ptr = torch.randint(0, num_edges, (num_nodes + 1,), dtype=torch.long, device=device)
    ...
    for _ in range(10):
        _ = model(x, edge_index, edge_weight, dst_ptr)
